"""
# `mcp:hummer_get_important_task_daily_duration`

查询一段时间内的重要Task每日的执行耗时数据，返回这段时间内每天的重点Task分类的耗时均值，执行次数
...
if __name__ == '__main__':
    ...
    try:
        result = call_aime_tool(
            toolset="hummer",
            tool_name="mcp:hummer_get_important_task_daily_duration",
